...
public class SeaTransformationAxolotlProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		if (entity == null)
			return;
		if ((entity.getCapability(ChildrenOfSilenceModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ChildrenOfSilenceModVariables.PlayerVariables())).isAxolotl) {
			...
			if (_evt.getRenderer() instanceof PlayerRenderer) {
				...
				new com.kleiders.kleidersplayerrenderer.KleidersPlayerRenderer(context, new ResourceLocation("children_of_silence:textures/entities/axolotl.png"), new Modelaxolotl(context.bakeLayer(Modelaxolotl.LAYER_LOCATION)))
