...
public class Modelhorizontal_slash<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("children_of_silence", "modelhorizontal_slash"), "main");
	public final ModelPart horizontalslash;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition horizontalslash = partdefinition.addOrReplaceChild("horizontalslash", CubeListBuilder.create().texOffs(-1, 5).addBox(-12.0F, -0.5F, -5.0F, 24.0F, 1.0F, 10.0F, new CubeDeformation(3.0F)),
