...
import net.mcreator.childrenofsilence.item.model.EsckDemonArmorModel;
import net.mcreator.childrenofsilence.item.EsckDemonArmorItem;

public class EsckDemonArmorArmorRenderer extends GeoArmorRenderer<EsckDemonArmorItem> {
	public EsckDemonArmorArmorRenderer() {
		super(new EsckDemonArmorModel());
	...
	@Override
	public RenderType getRenderType(EsckDemonArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
