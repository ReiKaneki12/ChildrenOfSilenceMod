...
public class FireBallRenderer extends EntityRenderer<FireBallEntity> {
	private static final ResourceLocation texture = new ResourceLocation("children_of_silence:textures/entities/fire_ball.png");
	private final Modelfire_ball model;

	public FireBallRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelfire_ball(context.bakeLayer(Modelfire_ball.LAYER_LOCATION));
	}
