...
import net.mcreator.childrenofsilence.item.model.EsckArmorModel;
import net.mcreator.childrenofsilence.item.EsckArmorItem;

public class EsckArmorArmorRenderer extends GeoArmorRenderer<EsckArmorItem> {
	public EsckArmorArmorRenderer() {
		super(new EsckArmorModel());
	...
	@Override
	public RenderType getRenderType(EsckArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
